    ...
    try {
      const { data, error } = await fine.auth.signUp.email(
        ...
        },
        {
          ...
          onError: (ctx) => {
            // If the error is that the user already exists, let them know
      ...
      // If the error message contains "already exists", redirect to login
        ...
        <form onSubmit={handleSubmit}>
          <CardContent className='space-y-4'>
            <Alert className="bg-blue-50 dark:bg-blue-950 border-blue-200 dark:border-blue-800">
              ...
              <AlertDescription>
                For demo purposes, you can use the pre-filled credentials or create your own account.
              </AlertDescription>
            </Alert>
